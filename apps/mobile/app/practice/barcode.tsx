...
export default function PracticeBarcodeScreen() {
  const alarm = PRACTICE_ALARMS.barcode;

  const onVerified = useCallback(() => {
    Alert.alert('Practice complete', 'Barcode gate marked verified (stub).', [
    ...
    <SafeAreaView style={styles.screen} edges={['bottom']}>
      <View style={styles.header}>
        ...
        <AppText variant="body" color={dashboardTheme.textMuted}>
          Scanner is a stub for now — use Mark verified to finish.
        </AppText>
      </View>
